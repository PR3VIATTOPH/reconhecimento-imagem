...
Forneça um código com erro(s) intencional, pegue algum código seu ou use o disponibilizado abaixo pelo professor, induza um erro de Sintaxe. Peça à IA para:
